...
const Header = () => {
    ...
    return (
        <header className="relative">
            ...
            {/* Slidebar Menu */}
            <div className={`fixed top-0 left-0 z-auto h-screen w-[300px] bg-tertiary-dark z-[99999] pt-20 px-6 transition-transform duration-500 ease-in-out ${slidebar ? 'translate-x-0' : '-translate-x-full'}`}>
